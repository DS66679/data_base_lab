...
**С помощью индексов мы проходимся всего по минимум 15 страниц индексов (log2(20000)). Пока ищем, не заходим в данные таблицы, а сканируем индекс и понимаем, что требуется достать из таблицы.**
