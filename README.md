...
**Seq Scan on driver_violation dv - показывает, что мы проходим по всей таблице driver_violation, 20000 строк.**
...
**С помощью индексов мы проходимся всего по максимум 15 страниц индексов (log2(20000)). Пока ищем, не заходим в данные таблицы, а сканируем индекс и понимаем, что требуется достать из таблицы.**
